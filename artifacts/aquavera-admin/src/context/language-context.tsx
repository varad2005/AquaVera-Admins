...
const translations: Translations = {
  ...
  "sidebar.survey_map": { en: "Survey Map", hi: "सर्वेक्षण मानचित्र", mr: "सर्वेक्षण नकाशा" },
  ...
  // Farmer Specific Navigation & Sidebar
  "sidebar.land_summary": { en: "Land Summary", hi: "भूमि सारांश", mr: "जमीन सारांश" },
  "sidebar.bill_summary": { en: "Bill Summary", hi: "बिल सारांश", mr: "बिल सारांश" },
  "sidebar.request_activity": { en: "Request Activity", hi: "अनुरोध गतिविधि", mr: "विनंती क्रियाकलाप" },
  "sidebar.request_water": { en: "Request Water", hi: "पानी का अनुरोध", mr: "पाण्याची विनंती" },

  // Farmer Dashboard General
  "farmer.welcome": { en: "Welcome back", hi: "वापसी पर स्वागत है", mr: "पुन्हा स्वागत आहे" },
  "farmer.irrigation_oversight": { en: "Financial oversight of your irrigation usage", hi: "आपकी सिंचाई उपयोग की वित्तीय देखरेख", mr: "तुमच्या सिंचन वापराची आर्थिक देखरेख" },
  "farmer.payment_done": { en: "Payment Done", hi: "भुगतान पूर्ण", mr: "देयक पूर्ण" },
  "farmer.payment_pending": { en: "Payment Pending", hi: "भुगतान लंबित", mr: "देयक प्रलंबित" },
  "farmer.approval_pending": { en: "Approval Pending", hi: "अनुमोदन लंबित", mr: "मंजूरी प्रलंबित" },
  "farmer.usage_trend": { en: "Usage Trend", hi: "उपयोग रुझान", mr: "वापर ट्रेंड" },
  "farmer.paid_desc": { en: "Cleared transactions", hi: "स्पष्ट लेनदेन", mr: "यशस्वी व्यवहार" },
  "farmer.pending_desc": { en: "Awaiting settlement", hi: "निपटान की प्रतीक्षा", mr: "तडजोडीची प्रतीक्षा" },
  "farmer.queue_desc": { en: "In verification queue", hi: "सत्यापन कतार में", mr: "पडताळणी रांगेत" },
  "farmer.prev_month": { en: "Vs previous month", hi: "पिछले महीने की तुलना में", mr: "मागील महिन्याच्या तुलनेत" },

  // Bill Summary Page
  "bill.title": { en: "Bill Summary", hi: "बिल सारांश", mr: "बिल सारांश" },
  "bill.pay_dues": { en: "Pay Dues", hi: "बकाया चुकाएं", mr: "थकीत रक्कम भरा" },
  "bill.history_title": { en: "Billing History", hi: "बिलिंग इतिहास", mr: "बिलिंग इतिहास" },
  "bill.request_id": { en: "Request ID", hi: "अनुरोध आईडी", mr: "विनंती आयडी" },
  "bill.date": { en: "Date", hi: "तारीख", mr: "तारीख" },
  "bill.crop": { en: "Crop", hi: "फसल", mr: "पीक" },
  "bill.consumption": { en: "Consumption", hi: "खपत", mr: "वापर" },
  "bill.amount": { en: "Amount", hi: "राशि", mr: "रक्कम" },
  "bill.status": { en: "Status", hi: "स्थिति", mr: "स्थिती" },
  "bill.pay_now": { en: "Pay Now", hi: "अभी भुगतान करें", mr: "आता भरा" },
  "bill.no_history": { en: "No billing history found.", hi: "कोई बिलिंग इतिहास नहीं मिला।", mr: "कोणताही बिलिंग इतिहास आढळला नाही." },

  // New Request Page
  "request.title": { en: "Request Water", hi: "पानी का अनुरोध", mr: "पाण्याची विनंती" },
  "request.step1": { en: "Crop Inputs", hi: "फसल इनपुट", mr: "पीक इनपुट" },
  "request.category": { en: "Crop Category", hi: "फसल श्रेणी", mr: "पीक श्रेणी" },
  "request.crop_name": { en: "Crop Name", hi: "फसल का नाम", mr: "पिकाचे नाव" },
  "request.season": { en: "Season", hi: "सीजन", mr: "हंगाम" },
  "request.land_area": { en: "Land Area", hi: "भूमि क्षेत्र", mr: "जमीन क्षेत्र" },
  "request.verification": { en: "Verification", hi: "सत्यापन", mr: "पडताळणी" },
  "request.estimate": { en: "Estimated Irrigation Bill", hi: "अनुमानित सिंचाई बिल", mr: "अंदाजित सिंचन बिल" },
  "request.submit": { en: "Submit Request", hi: "अनुरोध जमा करें", mr: "विनंती सादर करा" },
  "request.processing": { en: "Processing...", hi: "प्रसंस्करण...", mr: "प्रक्रिया करत आहे..." },
  "request.area_ha": { en: "Area (Converted)", hi: "क्षेत्र (परिवर्तित)", mr: "क्षेत्र (रूपांतरित)" },
  "request.rate_ha": { en: "Rate (per Ha)", hi: "दर (प्रति हेक्टेयर)", mr: "दर (प्रति हेक्टर)" },
  "request.includes_fees": { en: "Includes water distribution fees", hi: "जल वितरण शुल्क शामिल है", mr: "पाणी वितरण शुल्क समाविष्ट आहे" },
  "request.protocol_title": { en: "Verification Protocol", hi: "सत्यापन प्रोटोकॉल", mr: "पडताळणी प्रोटोकॉल" },
  "request.protocol_desc": { en: "Final billing depends on satellite verification and 7/12 land records.", hi: "अंतिम बिलिंग उपग्रह सत्यापन और 7/12 भूमि रिकॉर्ड पर निर्भर करती है।", mr: "अंतिम बिलिंग सॅटेलाइट पडताळणी आणि 7/12 जमीन रेकॉर्डवर अवलंबून असते." },

  // Seasons
  "season.kharif": { en: "Kharif", hi: "खरीफ", mr: "खरीप" },
  "season.rabi": { en: "Rabi", hi: "रबी", mr: "रब्बी" },
  "season.hot": { en: "Hot Weather", hi: "गर्मी का मौसम", mr: "उन्हाळी हंगाम" },

  // Land Summary Page
  "land.title": { en: "Land Summary", hi: "भूमि सारांश", mr: "जमीन सारांश" },
  "land.subtitle": { en: "Verified agricultural records and plot mapping", hi: "सत्यापित कृषि रिकॉर्ड और प्लॉट मैपिंग", mr: "सत्यापित कृषी रेकॉर्ड आणि प्लॉट मॅपिंग" },
  "land.verified_govt": { en: "Verified by Govt. Grid", hi: "सरकारी ग्रिड द्वारा सत्यापित", mr: "शासकीय ग्रिडद्वारे सत्यापित" },
  "land.particulars": { en: "Property Particulars", hi: "संपत्ति विवरण", mr: "मालमत्ता तपशील" },
  "land.request_update": { en: "Request Update", hi: "अपडेट का अनुरोध", mr: "अपडेटची विनंती" },
  "land.survey_no": { en: "Survey Number", hi: "सर्वेक्षण संख्या", mr: "सर्वेक्षण क्रमांक" },
  "land.record_no": { en: "7/12 Number", hi: "7/12 संख्या", mr: "7/12 क्रमांक" },
  "land.plot_no": { en: "Plot Number", hi: "प्लॉट संख्या", mr: "प्लॉट क्रमांक" },
  "land.total_area": { en: "Total Area", hi: "कुल क्षेत्र", mr: "एकूण क्षेत्र" },
  "land.state": { en: "State", hi: "राज्य", mr: "राज्य" },
  "land.taluka": { en: "Taluka", hi: "तालुका", mr: "तालुका" },
  "land.village": { en: "Village/City", hi: "गाँव/शहर", mr: "गाव/शहर" },
  "land.pincode": { en: "Pincode", hi: "पिनकोड", mr: "पिनकोड" },
  "land.soil": { en: "Soil Composition", hi: "मिट्टी की संरचना", mr: "मातीची रचना" },
  "land.elevation": { en: "Elevation Profile", hi: "ऊंचाई प्रोफ़ाइल", mr: "उंची प्रोफाइल" },
  "land.satellite_view": { en: "Satellite Live View", hi: "सैटेलाइट लाइव दृश्य", mr: "सॅटेलाइट लाइव्ह व्ह्यू" },
  "land.documents": { en: "Digital Documents", hi: "डिजिटल दस्तावेज", mr: "डिजिटल दस्तऐवज" },

  // Units
  "unit.acre": { en: "Acre", hi: "एकड़", mr: "एकर" },
  "unit.hectare": { en: "Hectare", hi: "हेक्टेयर", mr: "हेक्टर" },
  "unit.liters": { en: "Liters", hi: "लीटर", mr: "लिटर" },

  // Payment Page
  "payment.title": { en: "Select Method", hi: "तरीका चुनें", mr: "पद्धत निवडा" },
  "payment.success": { en: "Payment Successful!", hi: "भुगतान सफल!", mr: "देयक यशस्वी!" },
  "payment.receipt_desc": { en: "Your transaction was completed successfully. A digital receipt has been generated.", hi: "आपका लेनदेन सफलतापूर्वक पूरा हुआ। एक डिजिटल रसीद जेनरेट की गई है।", mr: "तुमचा व्यवहार यशस्वीरीत्या पूर्ण झाला आहे. डिजिटल पावती तयार केली गेली आहे." },
  "payment.transaction_id": { en: "Transaction ID", hi: "लेनदेन आईडी", mr: "व्यवहार आयडी" },
  "payment.amount_paid": { en: "Amount Paid", hi: "भुगतान की गई राशि", mr: "भरलेली रक्कम" },
  "payment.return": { en: "Return to Dashboard", hi: "डैशबोर्ड पर वापस जाएं", mr: "डॅशबोर्डवर परत जा" },
  "payment.card_no": { en: "Card Number", hi: "कार्ड नंबर", mr: "कार्ड नंबर" },
  "payment.expiry": { en: "Expiry Date", hi: "समाप्ति तिथि", mr: "कालबाह्यता तारीख" },
  "payment.cvv": { en: "CVV", hi: "सीवीवी", mr: "सीव्हीव्ही" },
  "payment.generate_qr": { en: "Generate Payment QR", hi: "भुगतान क्यूआर जेनरेट करें", mr: "देयक क्यूआर तयार करा" },
  "payment.confirm": { en: "Confirm Payment", hi: "भुगतान की पुष्टि करें", mr: "देयकाची पुष्टी करा" },
  "payment.secure_ssl": { en: "Secure 256-Bit SSL Encryption", hi: "सुरक्षित 256-बिट एसएसएल एन्क्रिप्शन", mr: "सुरक्षित 256-बिट एसएसएल एन्क्रिप्शन" },
  "payment.scan_pay": { en: "Scan to Pay", hi: "भुगतान के लिए स्कैन करें", mr: "पैसे भरण्यासाठी स्कॅन करा" },
  "payment.dynamic_qr": { en: "Generate a unique dynamic QR for this transaction", hi: "इस लेनदेन के लिए एक अद्वितीय गतिशील क्यूआर जेनरेट करें", mr: "या व्यवहारासाठी एक अद्वितीय डायनॅमिक क्यूआर तयार करा" },

  // Profile Page
  "profile.title": { en: "My Profile", hi: "मेरी प्रोफ़ाइल", mr: "माझी प्रोफाइल" },
  "profile.subtitle": { en: "Manage your personal and contact verification details", hi: "अपने व्यक्तिगत और संपर्क सत्यापन विवरण प्रबंधित करें", mr: "तुमचे वैयक्तिक आणि संपर्क पडताळणी तपशील व्यवस्थापित करा" },
  "profile.verified_account": { en: "K-Verified Account", hi: "के-सत्यापित खाता", mr: "के-सत्यापित खाते" },
  "profile.farmer_id": { en: "Verified Farmer ID", hi: "सत्यापित किसान आईडी", mr: "सत्यापित शेतकरी आयडी" },
  "profile.email": { en: "Email Address", hi: "ईमेल पता", mr: "ईमेल पत्ता" },
  "profile.phone": { en: "Phone Number", hi: "फ़ोन नंबर", mr: "फोन नंबर" },
  "profile.edit": { en: "Edit Basic Details", hi: "बुनियादी विवरण संपादित करें", mr: "मूलभूत तपशील संपादित करा" },
  "profile.govt_verification": { en: "Government Verification", hi: "सरकारी सत्यापन", mr: "शासकीय पडताळणी" },
  "profile.aadhaar": { en: "Aadhaar Card (Masked)", hi: "आधार कार्ड (मास्क्ड)", mr: "आधार कार्ड (मास्क केलेले)" },
  "profile.linked_active": { en: "Linked & Active", hi: "जुड़ा हुआ और सक्रिय", mr: "लिंक केलेले आणि सक्रिय" },
  "profile.location": { en: "Primary Location", hi: "प्राथमिक स्थान", mr: "प्राथमिक स्थान" },
  "profile.update_location": { en: "Update Location", hi: "स्थान अपडेट करें", mr: "स्थान अपडेट करा" },
  "profile.last_updated": { en: "Profile Last Updated", hi: "प्रोफ़ाइल अंतिम बार अपडेट की गई", mr: "प्रोफाइल शेवटची अपडेट केली" },
  "profile.synced": { en: "Synced with AquaVera Central Grid", hi: "एक्वावेरा सेंट्रल ग्रिड के साथ समन्वयित", mr: "AquaVera सेंट्रल ग्रिडशी सिंक केले" },

  // Activity Page
  "activity.title": { en: "Request Activity", hi: "अनुरोध गतिविधि", mr: "विनंती क्रियाकलाप" },
  "activity.subtitle": { en: "History of all your water allocation requests", hi: "आपके सभी जल आवंटन अनुरोधों का इतिहास", mr: "तुमच्या सर्व पाणी वाटप विनंत्यांचा इतिहास" },
  "activity.loading": { en: "Loading your activity...", hi: "आपकी गतिविधि लोड हो रही है...", mr: "तुमची क्रियाकलाप लोडिंग होत आहे..." },
  "activity.no_requests": { en: "No requests found", hi: "कोई अनुरोध नहीं मिला", mr: "कोणतीही विनंती आढळली नाही" },
  "activity.no_requests_desc": { en: "You haven't submitted any water requests yet.", hi: "आपने अभी तक कोई जल अनुरोध सबमिट नहीं किया है।", mr: "तुम्ही अद्याप कोणतीही पाण्याची विनंती सबमिट केलेली नाही." },
  "activity.request_now": { en: "Request Now", hi: "अभी अनुरोध करें", mr: "आता विनंती करा" },
  "activity.billing": { en: "Billing", hi: "बिलिंग", mr: "बिलिंग" },
  "activity.status": { en: "Status", hi: "स्थिति", mr: "स्थिती" },

  // Registration & Onboarding Extensions
  "signup.creating": { en: "Creating Account...", hi: "खाता बनाया जा रहा है...", mr: "खाते तयार करत आहे..." },
  "profile.establishment_desc": { en: "Your farmer profile has been established.", hi: "आपकी किसान प्रोफ़ाइल स्थापित हो गई है।", mr: "तुमची शेतकरी प्रोफाइल स्थापित झाली आहे." },
  "profile.verifying_creds": { en: "Verifying Credentials...", hi: "क्रेडेंशियल सत्यापित किए जा रहे हैं...", mr: "क्रेडेन्शियल्स पडताळत आहे..." },
  "profile.identity_assets": { en: "Identity & Land Assets", hi: "पहचान और भूमि संपत्ति", mr: "ओळख आणि जमीन मालमत्ता" },
  "profile.verify_ownership": { en: "Verify your citizenship and ownership", hi: "अपनी नागरिकता और स्वामित्व सत्यापित करें", mr: "तुमची नागरिकत्व आणि मालकी पडताळा" },
  "profile.regional_placement": { en: "Regional Placement", hi: "क्षेत्रीय प्लेसमेंट", mr: "प्रादेशिक प्लेसमेंट" },
  "profile.irrigation_zone": { en: "Specify your primary irrigation zone", hi: "अपना प्राथमिक सिंचाई क्षेत्र निर्दिष्ट करें", mr: "तुमचा प्राथमिक सिंचन झोन निर्दिष्ट करा" },
  "profile.submit_verification": { en: "Submit for Verification", hi: "सत्यापन के लिए सबमिट करें", mr: "पडताळणीसाठी सबमिट करा" },
  "profile.id_req": { en: "Identity Verification Required", hi: "पहचान सत्यापन आवश्यक", mr: "ओळख पडताळणी आवश्यक" },
  "profile.establish": { en: "Establish Your Farmer Profile", hi: "अपनी किसान प्रोफ़ाइल स्थापित करें", mr: "तुमची शेतकरी प्रोफाइल स्थापित करा" },
  "profile.doc_sync": { en: "Please provide your official documentation to sync your land records with the AquaVera Smart Irrigation Grid.", hi: "एक्वावेरा स्मार्ट सिंचाई ग्रिड के साथ अपने भूमि रिकॉर्ड को सिंक्रनाइज़ करने के लिए कृपया अपने आधिकारिक दस्तावेज प्रदान करें।", mr: "तुमचे जमिनीचे रेकॉर्ड AquaVera स्मार्ट सिंचन ग्रिडसह सिंक करण्यासाठी कृपया तुमची अधिकृत कागदपत्रे प्रदान करा." },
  "profile.encrypted_sync": { en: "Your data is encrypted and synced directly with the Ministry of Agriculture databases for instant verification.", hi: "आपका डेटा एन्क्रिप्टेड है और त्वरित सत्यापन के लिए सीधे कृषि मंत्रालय के डेटाबेस के साथ समन्वयित किया गया है।", mr: "तुमचा डेटा कूटबद्ध केला आहे आणि झटपट पडताळणीसाठी थेट कृषी मंत्रालयाच्या डेटाबेससह सिंक केला आहे." },
  "profile.aadhaar_label": { en: "Aadhaar Card Number", hi: "आधार कार्ड नंबर", mr: "आधार कार्ड क्रमांक" },
  "profile.land_record_label": { en: "7/12 Land Record ID", hi: "7/12 लैंड रिकॉर्ड आईडी", mr: "7/12 जमीन रेकॉर्ड आयडी" },
  "profile.survey_number": { en: "Survey Number", hi: "सर्वेक्षण संख्या", mr: "सर्वेक्षण क्रमांक" },
  "profile.plot_number": { en: "Plot Number", hi: "प्लॉट नंबर", mr: "गट क्रमांक" },
  "common.section": { en: "Section", hi: "अनुभाग", mr: "विभाग" },

  // Farmer Dashboard
  "dashboard.hello": { en: "Hello", hi: "नमस्ते", mr: "नमस्कार" },
  "dashboard.status_today": { en: "Here’s your farm status for today", hi: "यहाँ आज के लिए आपके खेत की स्थिति है", mr: "येथे आजची तुमच्या शेतीची स्थिती आहे" },
  "dashboard.request_water": { en: "Request Water", hi: "जल अनुरोध", mr: "पाणी विनंती" },
  "dashboard.start_irrigation": { en: "Start Irrigation", hi: "सिंचाई शुरू करें", mr: "सिंचन सुरू करा" },
  "dashboard.request_desc": { en: "Instantly trigger a new irrigation sequence for your crop and sync with the smart grid.", hi: "तुरंत अपनी फसल के लिए एक नया सिंचाई क्रम ट्रिगर करें और स्मार्ट ग्रिड के साथ समन्वयित करें।", mr: "तुमच्या पिकासाठी त्वरित एक नवीन सिंचन क्रम सुरू करा आणि स्मार्ट ग्रिडशी सिंक करा." },
  "dashboard.schedule_now": { en: "Schedule Now", hi: "अभी शेड्यूल करें", mr: "आता शेड्युल करा" },
  "dashboard.farm_overview": { en: "Farm Overview", hi: "खेत का अवलोकन", mr: "शेतीचा आढावा" },
  "dashboard.real_time": { en: "Real-time status tracking", hi: "रीयल-टाइम स्थिति ट्रैकिंग", mr: "रिअल-टाइम स्थिती ट्रॅकिंग" },
  "dashboard.active_request": { en: "Active Request", hi: "सक्रिय अनुरोध", mr: "सक्रिय विनंती" },
  "dashboard.last_crop": { en: "Last Crop", hi: "पिछली फसल", mr: "शेवटची पीक" },
  "dashboard.total_billing": { en: "Total Billing", hi: "कुल बिलिंग", mr: "एकूण बिलिंग" },
  "dashboard.recent_activity": { en: "Recent Activity", hi: "हाल की गतिविधि", mr: "नुकताच क्रियाकलाप" },
  "dashboard.view_all": { en: "View All", hi: "सभी देखें", mr: "सर्व पहा" },
  "dashboard.no_requests": { en: "No water requests yet", hi: "अभी तक कोई जल अनुरोध नहीं", mr: "अद्याप कोणतीही पाण्याची विनंती नाही" },
  "dashboard.no_requests_desc": { en: "Your irrigation history is currently empty. Start by requesting water for your crop.", hi: "आपका सिंचाई इतिहास वर्तमान में खाली है। अपनी फसल के लिए पानी मांगकर शुरुआत करें।", mr: "तुमचा सिंचन इतिहास सध्या रिकामा आहे. तुमच्या पिकासाठी पाण्याची विनंती करून सुरुवात करा." },
  "dashboard.farm_insights": { en: "Farm Insights", hi: "खेत की जानकारी", mr: "शेतीची माहिती" },
  "dashboard.data_driven": { en: "Data-driven suggestions", hi: "डेटा-आधारित सुझाव", mr: "डेटा-चालित सूचना" },
  "dashboard.best_crop": { en: "Best Current Crop", hi: "सर्वोत्तम वर्तमान फसल", mr: "सर्वोत्तम वर्तमान पीक" },
  "dashboard.next_irrigation": { en: "Next Irrigation", hi: "अगली सिंचाई", mr: "पुढील सिंचन" },
  "dashboard.water_usage": { en: "Water Usage", hi: "पानी का उपयोग", mr: "पाण्याचा वापर" },
  "dashboard.active_land": { en: "Active Land Profile", hi: "सक्रिय भूमि प्रोफ़ाइल", mr: "सक्रिय जमीन प्रोफाइल" },
  "dashboard.govt_survey": { en: "Synced with Govt. Survey Grid", hi: "सरकारी सर्वेक्षण ग्रिड के साथ समन्वयित", mr: "शासकीय सर्वेक्षण ग्रिडशी सिंक केले" },
  "dashboard.none": { en: "None", hi: "कोई नहीं", mr: "काही नाही" },
  "dashboard.not_recorded": { en: "Not Recorded", hi: "दर्ज नहीं", mr: "नोंदलेले नाही" }
};
